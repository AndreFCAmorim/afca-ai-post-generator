...
class AIPG_Admin {
    ...
    public function enqueue_assets( string $hook ): void {
        ...
        wp_enqueue_style( 'aipg-admin', AIPG_PLUGIN_URL . 'assets/admin.css', [], AIPG_VERSION );
        wp_enqueue_script( 'aipg-admin', AIPG_PLUGIN_URL . 'assets/admin.js', [ 'jquery' ], AIPG_VERSION, true );
        ...
        wp_localize_script( 'aipg-admin', 'aipgData', [
    ...
    public function ajax_generate_now(): void {
        ...
        unset( $entry );
        update_option( AIPG_LOG_OPTION, array_slice( $log, 0, 50 ) );
    ...
    public function pending_posts_notice(): void {
        ...
        $pending = get_posts( [
            'post_status' => 'pending', 'meta_key' => '_aipg_generated',
            'meta_value' => '1', 'posts_per_page' => -1, 'fields' => 'ids',
        ] );
    ...
    public function render_settings_page(): void {
        require_once AIPG_PLUGIN_DIR . 'admin/views/settings.php';
    }

    public function render_log_page(): void {
        require_once AIPG_PLUGIN_DIR . 'admin/views/log.php';
    }
}
