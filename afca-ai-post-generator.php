<?php
/**
 * Plugin Name:       AFCA AI Post Generator
 * Plugin URI:        https://www.andreamorim.site/plugin-documentation/afca-ai-post-generator/
 ...
 * Text Domain:       afca-ai-post-generator
 */
...
define( 'AFCA_AIPG_CRON_HOOK', 'afca_aipg_generate_post_event' );
define( 'AFCA_AIPG_LOG_OPTION', 'afca_aipg_generation_log' );
...
// ─── Boot ─────────────────────────────────────────────────────────────────────
function afca_aipg_init(): void {
	AIPG_Settings::get_instance();
	AIPG_Cron::get_instance();
	AIPG_Admin::get_instance();
}
add_action( 'plugins_loaded', 'afca_aipg_init' );

// ─── Activation / Deactivation ────────────────────────────────────────────────
register_activation_hook( __FILE__, 'afca_aipg_activate' );
function afca_aipg_activate(): void {
	AIPG_Cron::schedule();
	AIPG_Settings::set_defaults();
}

register_deactivation_hook( __FILE__, 'afca_aipg_deactivate' );
function afca_aipg_deactivate(): void {
