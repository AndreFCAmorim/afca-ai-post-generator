...
define( 'AIPG_CRON_HOOK',   'aipg_generate_post_event' );
define( 'AIPG_LOG_OPTION',  'aipg_generation_log' );

// ─── Core classes ─────────────────────────────────────────────────────────────
require_once AIPG_PLUGIN_DIR . 'includes/class-settings.php';

// Provider system
require_once AIPG_PLUGIN_DIR . 'includes/providers/class-provider-base.php';
require_once AIPG_PLUGIN_DIR . 'includes/providers/class-provider-gemini.php';
require_once AIPG_PLUGIN_DIR . 'includes/providers/class-provider-openai-compat.php';
require_once AIPG_PLUGIN_DIR . 'includes/providers/class-provider-anthropic.php';
require_once AIPG_PLUGIN_DIR . 'includes/providers/class-provider-factory.php';

// Generator, cron, admin
require_once AIPG_PLUGIN_DIR . 'includes/class-generator.php';
require_once AIPG_PLUGIN_DIR . 'includes/class-cron.php';
require_once AIPG_PLUGIN_DIR . 'includes/class-admin.php';
