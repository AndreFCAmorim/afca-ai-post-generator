...
<div class="wrap aipg-wrap">
    ...
    <div class="aipg-header">
        ...
        <div class="aipg-header__text">
            <h1><?php esc_html_e( 'AI Post Generator', 'afca-ai-post-generator' ); ?></h1>
            <p><?php esc_html_e( 'Automatically draft posts with AI — ready for your editorial review.', 'afca-ai-post-generator' ); ?></p>
        </div>
        <div class="aipg-header__status">
            <?php if ( AIPG_Settings::is_enabled() ) : ?>
                <span class="aipg-badge aipg-badge--on">● <?php esc_html_e( 'Enabled', 'afca-ai-post-generator' ); ?></span>
            <?php else : ?>
                <span class="aipg-badge aipg-badge--off">● <?php esc_html_e( 'Disabled', 'afca-ai-post-generator' ); ?></span>
            <?php endif; ?>
            <?php if ( $next_run ) : ?>
                <span class="aipg-badge aipg-badge--info">
                    ⏱ <?php printf( esc_html__( 'Next run: %s', 'afca-ai-post-generator' ), esc_html( human_time_diff( $next_run ) . ' from now' ) ); ?>
                </span>
            <?php endif; ?>
        </div>
    </div>
    ...
    <form method="post" action="" id="aipg-settings-form">
        <?php wp_nonce_field( 'afca_aipg_save_settings', 'afca_aipg_nonce' ); ?>
        <input type="hidden" name="afca_aipg_save_settings" value="1">

        <!-- ══ PROVIDER SELECTOR ══════════════════════════════════════════ -->
        <div class="aipg-card aipg-card--provider-select">
            <div class="aipg-card__header">
                <span class="aipg-card__icon">⚙️</span>
                <h2><?php esc_html_e( 'AI Provider', 'afca-ai-post-generator' ); ?></h2>
            </div>
        ...
        <div class="aipg-provider-config" data-provider="<?php echo esc_attr( $slug ); ?>"
            ...
            <div class="aipg-card">
                <div class="aipg-card__header">
                    ...
                    <h2><?php printf( esc_html__( '%s Configuration', 'afca-ai-post-generator' ), esc_html( $cfg['label'] ) ); ?></h2>
                    <a href="<?php echo esc_url( $cfg['signup_url'] ); ?>" target="_blank" class="aipg-signup-link">
                        <?php esc_html_e( 'Get API Key →', 'afca-ai-post-generator' ); ?>
                    </a>
                </div>
                <div class="aipg-card__body">
                    <div class="aipg-field-row">
                        <div class="aipg-field">
                            <label><?php printf( esc_html__( '%s API Key', 'afca-ai-post-generator' ), esc_html( $cfg['label'] ) ); ?> <span class="aipg-required">*</span></label>
                            <div class="aipg-input-group">
                                <input type="password"
                                       name="afca_aipg_api_key_<?php echo esc_attr( $slug ); ?>"
                        ...
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Model', 'afca-ai-post-generator' ); ?></label>
                            <select name="afca_aipg_model_<?php echo esc_attr( $slug ); ?>">
                    ...
                    <div class="aipg-test-api">
                        <button type="button" class="button button-secondary aipg-test-api-btn">
                            🧪 <?php esc_html_e( 'Test Connection', 'afca-ai-post-generator' ); ?>
                        </button>
        ...
        <div class="aipg-grid">
            ...
            <div class="aipg-col">
                ...
                <div class="aipg-card">
                    <div class="aipg-card__header">
                        <span class="aipg-card__icon">📅</span>
                        <h2><?php esc_html_e( 'Schedule', 'afca-ai-post-generator' ); ?></h2>
                    </div>
                    <div class="aipg-card__body">
                        <div class="aipg-field aipg-field--inline">
                            <label><?php esc_html_e( 'Enable automatic generation', 'afca-ai-post-generator' ); ?></label>
                        ...
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Frequency', 'afca-ai-post-generator' ); ?></label>
                        ...
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Posts per run', 'afca-ai-post-generator' ); ?></label>
                            ...
                            <p class="description"><?php esc_html_e( 'How many posts to generate per run (1–10).', 'afca-ai-post-generator' ); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="aipg-card">
                    <div class="aipg-card__header">
                        <span class="aipg-card__icon">📝</span>
                        <h2><?php esc_html_e( 'Post Metadata', 'afca-ai-post-generator' ); ?></h2>
                    </div>
                    <div class="aipg-card__body">
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Post Author', 'afca-ai-post-generator' ); ?> <span class="aipg-required">*</span></label>
                            <?php wp_dropdown_users( [
                                'name'             => AIPG_Settings::OPT_AUTHOR_ID,
                                'id'               => AIPG_Settings::OPT_AUTHOR_ID,
                                'selected'         => AIPG_Settings::get_author_id(),
                                'show_option_none' => __( '— Select an author —', 'afca-ai-post-generator' ),
                                'who'              => 'authors',
                            ] ); ?>
                        </div>
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Category', 'afca-ai-post-generator' ); ?></label>
                            <select name="<?php echo esc_attr( AIPG_Settings::OPT_POST_CATEGORY ); ?>">
                                <option value="0"><?php esc_html_e( '— Uncategorized —', 'afca-ai-post-generator' ); ?></option>
                        ...
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Fixed Tags', 'afca-ai-post-generator' ); ?></label>
                            ...
                            <p class="description"><?php esc_html_e( 'Comma-separated. AI-suggested tags are added automatically too.', 'afca-ai-post-generator' ); ?></p>
                        </div>
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Output Language', 'afca-ai-post-generator' ); ?></label>
            ...
            <div class="aipg-col">
                ...
                <div class="aipg-card">
                    <div class="aipg-card__header">
                        <span class="aipg-card__icon">💡</span>
                        <h2><?php esc_html_e( 'Topics', 'afca-ai-post-generator' ); ?></h2>
                    </div>
                    <div class="aipg-card__body">
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Topic List', 'afca-ai-post-generator' ); ?> <span class="aipg-required">*</span></label>
                            ...
                            <p class="description"><?php printf(
                                esc_html( _n( 'One topic per line. %d topic configured.', 'One topic per line. %d topics configured.', count( AIPG_Settings::get_topics() ), 'afca-ai-post-generator' ) ),
                ...
                <div class="aipg-card">
                    <div class="aipg-card__header">
                        <span class="aipg-card__icon">📋</span>
                        <h2><?php esc_html_e( 'Writing Requirements', 'afca-ai-post-generator' ); ?></h2>
                    </div>
                    <div class="aipg-card__body">
                        <div class="aipg-field">
                            <label><?php esc_html_e( 'Instructions for the AI', 'afca-ai-post-generator' ); ?></label>
                            ...
                            <p class="description"><?php esc_html_e( 'One instruction per line. Be specific about tone, format, length, and mandatory sections.', 'afca-ai-post-generator' ); ?></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="aipg-card aipg-card--action">
                    <div class="aipg-card__header">
                        <span class="aipg-card__icon">⚡</span>
                        <h2><?php esc_html_e( 'Manual Generation', 'afca-ai-post-generator' ); ?></h2>
                    </div>
                    <div class="aipg-card__body">
                        <p><?php esc_html_e( 'Trigger a generation run immediately, outside of the schedule.', 'afca-ai-post-generator' ); ?></p>
                        <button type="button" class="button button-primary button-hero" id="aipg-generate-now">
                            ⚡ <?php esc_html_e( 'Generate Now', 'afca-ai-post-generator' ); ?>
                        </button>
        ...
        <div class="aipg-save-bar">
            <button type="submit" class="button button-primary button-large">💾 <?php esc_html_e( 'Save Settings', 'afca-ai-post-generator' ); ?></button>
            <a href="<?php echo esc_url( admin_url( 'admin.php?page=ai-post-generator-log' ) ); ?>" class="button button-secondary button-large">
                📋 <?php esc_html_e( 'View Generation Log', 'afca-ai-post-generator' ); ?>
            </a>
        </div>
